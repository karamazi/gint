...
Division = function (stage, x, y, value, base) {
    ...
    this.initText = new PIXI.Text(value + " / " + base, textStyle);
    this.resultText = new PIXI.Text("", textStyle);
    this.initText.position = new PIXI.Point(x, y);
    this.resultText.position = new PIXI.Point(x + 220, y);

    stage.addChild(this.initText);
...
Division.prototype.clearStage = function (stage) {
    stage.removeChild(this.initText);
    stage.removeChild(this.resultText);
}   
